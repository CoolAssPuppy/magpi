...
describe('billing configuration', () => {
  it('reads the three SB_ prefixed values Stripe needs', () => {
    withStripeEnv({
      SB_STRIPE_SECRET_KEY: 'sk_test_1',
      SB_STRIPE_WEBHOOK_SECRET: 'whsec_test_1',
      SB_STRIPE_PRICE_TEAM: 'price_team_1',
    });
