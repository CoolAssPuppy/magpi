...
function FirstRun() {
  return (
    <EmptyState
      title="Give Recall something to read"
      description="Upload a document or connect a source. Recall indexes what it finds and answers from it, with the passage it used attached to every answer."
      action={
